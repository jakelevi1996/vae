...
\begin{frame}
    ...
    \begin{align*}
        ...
        \hat{\mathcal{L}}(x_n, \theta, \phi) &= \textcolor{blue}{\frac{1}{2}\sum_i \Bigl[ 1 + 2\log(\sigma_i) - \mu_j^2 - \sigma_j^2 \Bigr]} \\
        ...
        \mathbb{E}\Bigl[ \hat{\mathcal{L}}(x_n, \theta, \phi) \Bigr] &= \mathcal{L}(x_n, \theta, \phi) \tag{Unbiased \Smiley}
    \end{align*}
\end{frame}
