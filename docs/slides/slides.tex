...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \item Observe data $x = \{x_1, \dots, x_N\}$, large $N$
        \item Assume $x \sim p(x \,|\, \theta^*)$
        \item[$\bigstar$] Learn $\theta = \text{argmax}_\theta\Bigl[ \log\Bigl( p(x \,|\, \theta) \Bigr) \Bigr]$ (metric)
        ...
        \begin{align*}
            ...
            p(x_n \,\vert\, \theta) &= \int dz_n \Bigl[ p\bigl(x_n, z_n \,\vert\, \theta\bigr) \Bigr] \tag{Latent variables} \\
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            &= \sum_{n=1}^N \left[ \log\left( \int dz_n \Bigl[ p\bigl( z_n \,\vert\, \theta \bigr)\;p\bigl( x_n \,\vert\, z_n, \theta \bigr) \Bigr] \right) \right] \tag{Generative model} \\
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \vspace{0.5em}
            \setlength{\itemsep}{0.5em}
            \item Fix $p( z_n \,\vert\, \theta ) = \mathcal{N}(z_n \,|\, 0, I)$, $p\bigl( x_n \,\vert\, z_n, \theta \bigr) = \text{MLP}$
        ...
        \begin{itemize}
            ...
            \item p(sample close to true $z_n$) = tiny $\Rightarrow$ need many samples
        \end{itemize}
        \item Instead choose $q(z_n \vert x_n, \phi) \approx p(z_n \vert x_n, \theta)$, maximise ELBO
    \end{itemize}
\end{frame}
