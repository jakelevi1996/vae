...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Results: \url{https://github.com/jakelevi1996/vae/\#results}
        \item NB for MNIST:
        \begin{itemize}
            \vspace{0.5em}
            \setlength{\itemsep}{1em}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item LARGE unlabelled dataset $\{x_i, \dots\}$
            \item small labelled dataset $\{(x_j, y_j), \dots\}$
            \item Train classifier
            \item Outperform ignoring $\{x_i, \dots\}$
        \end{itemize}
        \item 2 models proposed:
        \begin{itemize}
