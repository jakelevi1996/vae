...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item $\partial\mathcal{L}/\partial x$ (BP)
            \item SGD
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Train property prediction $f_\text{prop}(z_n) = \pi$, $f_\text{prop}$ = MLP or GP, $\pi = \dots$
        \begin{itemize}
        ...
        \begin{itemize}
            \item $z_n = \text{argmin}_{z_n}\Bigl[ \mathcal{L}\Bigl(f_\text{prop}(z_n), \pi^*\Bigr) \Bigr]$ (EG BP through $f_\text{prop}$ + SGD)
