...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Reconstruct $\Rightarrow$ learn realistic generative model
    \end{itemize}
\end{frame}
...
\begin{frame}[t]
    ...
    \begin{itemize}
        ...
        \end{align*}
        \item Cost is ``amortised'' into $\phi$
        \item Learn good $\phi\;\Rightarrow$ have $q(z_n \vert x_n, \phi)$ for \emph{all} $x_n$
    \end{itemize}
\end{frame}
